			...
			<div class="row">
				<div class="col-md-7">
					<div class="ltn__top-bar-menu">
						<ul>
							<li><a href="locations.php"><i class="icon-placeholder"></i> Cancun, Quintana Roo</a></li>
							<li><a href="mailto:info@webmail.com?Subject=Flower%20greetings%20to%20you"><i class="icon-mail"></i> kingplus@gmail.com</a></li>
						</ul>
					</div>
				</div>
				<div class="col-md-5">
			...
			<div class="row">
				<div class="col">
					<div class="site-logo-wrap">
						<div class="site-logo">
							<a href="index.php"><img src="img/logo-4.png" width="154px" height="54px" alt="Logo"></a>
						</div>
					</div>
				</div>
					...
					<div class="header-menu d-none d-xl-block">
						<nav>
							<div class="ltn__main-menu">
								<ul>
									<li class="menu-icon"><a href="index.php">Inicio</a>
									</li>
									<li class="menu-icon">
									...
									<li class="special-link"><a href="shop.php">COMPRAR</a></li>
								</ul>
							</div>
						</nav>
					</div>
					...
					<div class="header-search-wrap">
						...
						<div class="header-search-1-form">
							<form id="#" method="get" action="#" submit.prevent="realizarBusqueda">
								<input type="text" v-model="terminoBusqueda" name="search" value="" placeholder="Busca aquí..." />
								<button type="submit">
