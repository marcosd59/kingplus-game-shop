					...
					<div class="col-lg-12">
						<div class="coming-soon-inner">
							<div class="section-title-area ltn__section-title-2">
								<h6 class="section-subtitle ltn__secondary-color-4">// Pago NO Aprobado</h6>
								<h1 class="section-title white-color">Su pago fue rechazado. Por favor, intentelo nuevamente.</h1>
							</div>
						</div>
					</div>
				</div>
