                                        ...
                                        <div class="ltn__drop-menu ltn__currency-menu">
                                            <ul>
                                                <li><a href="#" class="dropdown-toggle"><span class="active-currency">USD</span></a>
                                                    <ul>
                                                        <li><a href="login.php">USD - US Dollar</a></li>
                                                        <li><a href="wishlist.php">CAD - Canada Dollar</a></li>
                                                        <li><a href="register.php">EUR - Euro</a></li>
                                                        <li><a href="account.php">GBP - British Pound</a></li>
                                                        <li><a href="wishlist.php">INR - Indian Rupee</a></li>
                                                        <li><a href="wishlist.php">BDT - Bangladesh Taka</a></li>
                                                        <li><a href="wishlist.php">JPY - Japan Yen</a></li>
                                                        <li><a href="wishlist.php">AUD - Australian Dollar</a></li>
                                                    </ul>
                                                </li>
                                            </ul>
                                        </div>
                                        ...
                                        <ul>
                                            <li class="menu-icon"><a href="#">Home</a>
                                                <ul class="sub-menu menu-pages-img-show ltn__sub-menu-col-2---">
                                                    ...
                                                    <li>
                                                        <a href="index-10.php">Home Style 10</a>
                                                        <img src="img/home-demos/home-10.jpg" alt="#">
                                                    </li>
                                                    <li>
                                                        <a href="index-11.php">Home Style 11 <span class="menu-item-badge">Service</span></a>
                                            ...
                                            <li class="menu-icon"><a href="#">About</a>
                                                <ul>
                                                    ...
                                                    <li><a href="portfolio-2.php">Gallery - 02</a></li>
                                                    <li><a href="portfolio-details.php">Gallery Details</a></li>
                                            ...
                                            <li class="menu-icon"><a href="#">Shop</a>
                                                <ul>
                                                    ...
                                                    <li><a href="product-details-no-sidebar.php">Shop details no sidebar </a></li>
                                            ...
                                            <li class="menu-icon"><a href="#">Pages</a>
                                                <ul class="mega-menu">
                                                    ...
                                                    <li><a href="shop.php"><img src="img/banner/menu-banner-1.png" alt="#"></a>
                                                    </li>
                                                </ul>
                                            </li>
                                            <li><a href="contact.php">Contact</a></li>
                            ...
                            <div class="ltn__category-menu-toggle ltn__one-line-active">
                                <ul>
                                    ...
                                    <li class="ltn__category-menu-item ltn__category-menu-drop">
                                        <a href="shop.php"><i class="icon-shopping-bags"></i>Vegetables and Fruits </a>
                                    ...
                                    <!-- Submenu Column - 4 -->
                                    <li class="ltn__category-menu-item ltn__category-menu-drop">
                                        <a href="shop.php"><i class="icon-options"></i>Fresh Meat </a>
                                    ...
                                    <!-- Submenu Column - 3 -->
                                    <li class="ltn__category-menu-item ltn__category-menu-drop">
                                        <a href="shop.php"><i class="icon-award"></i>Fish and Seafood</a>
                                    ...
                                    <!-- Submenu Column - 2 -->
                                    <li class="ltn__category-menu-item ltn__category-menu-drop">
                                        <a href="shop.php"><i class="icon-user"></i>Butter and Cream</a>
                                    ...
                                    <!-- Submenu -->
                                    <li class="ltn__category-menu-item ltn__category-menu-drop">
                                        <a href="shop.php"><i class="icon-shopping-cart"></i>Oil and Vinegar</a>
                                    ...
                                    <!-- Submenu -->
                                    <li class="ltn__category-menu-item ltn__category-menu-drop">
                                        <a href="shop.php"><i class="icon-tag"></i>Breads</a>
                                        <ul class="ltn__category-submenu">
                                            <li class="ltn__category-submenu-title ltn__category-menu-drop"><a href="#">Handbags</a>
                                                <ul class="ltn__category-submenu-children">
                                                    <li><a href="#">Clutches</a></li>
                                    ...
                                    <!-- Submenu -->
                                    <li class="ltn__category-menu-item ltn__category-menu-drop">
                                        <a href="shop.php"><i class="icon-shopping-bags"></i>Apple Juice </a>
                                        <ul class="ltn__category-submenu">
                                            <li class="ltn__category-submenu-title ltn__category-menu-drop"><a href="#">Handbags</a>
                                                <ul class="ltn__category-submenu-children">
                                                    <li><a href="#">Clutches</a></li>
                                    ...
                                    <!-- Submenu -->
                                    <li class="ltn__category-menu-item ltn__category-menu-drop">
                                        <a href="shop.php"><i class="icon-options"></i>Dry Nuts</a>
                                        <ul class="ltn__category-submenu">
                                            <li class="ltn__category-submenu-title ltn__category-menu-drop"><a href="#">Handbags</a>
                                                <ul class="ltn__category-submenu-children">
                                                    <li><a href="#">Clutches</a></li>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-5 col-md-5 col-sm-5 align-self-center">
                                                <div class="slide-item-img">
                                                    <!-- <a href="shop.php"><img src="img/product/1.png" alt="Image"></a> -->
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="ltn__slide-item-inner">
                                    <div class="container">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-5 col-md-5 col-sm-5 align-self-center">
                                                <div class="slide-item-img">
                                                    <!-- <a href="shop.php"><img src="img/slider/62.jpg" alt="Image"></a> -->
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="ltn__product-item ltn__product-item-3 text-center">
                            ...
                            <div class="product-info">
                                ...
                                <h2 class="product-title"><a href="product-details.php">Vegetables Juices</a></h2>
                                <div class="product-price">
                                    <span>$62.00</span>
                                    <del>$85.00</del>
                                </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="call-to-action-inner call-to-action-inner-2 text-center">
                            ...
                            <div class="btn-wrapper">
                                <a class="btn btn-effect-4 btn-white" href="contact.php"><i class="fas fa-phone-volume"></i> MAKE A CALL</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="ltn__small-product-item">
                            <div class="small-product-item-img">
                                <a href="product-details.php"><img src="img/product/1.png" alt="Image"></a>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="ltn__small-product-item">
                            <div class="small-product-item-img">
                                <a href="product-details.php"><img src="img/product/2.png" alt="Image"></a>
                            </div>
                            <div class="small-product-item-info">
                                <div class="product-ratting">
                                    <ul>
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="ltn__small-product-item">
                            <div class="small-product-item-img">
                                <a href="product-details.php"><img src="img/product/3.png" alt="Image"></a>
                            </div>
                            <div class="small-product-item-info">
                                <div class="product-ratting">
                                    <ul>
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="ltn__small-product-item">
                            <div class="small-product-item-img">
                                <a href="product-details.php"><img src="img/product/4.png" alt="Image"></a>
                            </div>
                            <div class="small-product-item-info">
                                <div class="product-ratting">
                                    <ul>
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="ltn__small-product-item">
                            <div class="small-product-item-img">
                                <a href="product-details.php"><img src="img/product/5.png" alt="Image"></a>
                            </div>
                            <div class="small-product-item-info">
                                <div class="product-ratting">
                                    <ul>
                                ...
                                <h2 class="product-title"><a href="product-details.php">Coil Spring Kit</a></h2>
                                <div class="product-price">
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="ltn__small-product-item">
                            <div class="small-product-item-img">
                                <a href="product-details.php"><img src="img/product/6.png" alt="Image"></a>
                            </div>
                            <div class="small-product-item-info">
                                <div class="product-ratting">
                                    <ul>
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="ltn__small-product-item">
                            <div class="small-product-item-img">
                                <a href="product-details.php"><img src="img/product/7.png" alt="Image"></a>
                            </div>
                            <div class="small-product-item-info">
                                <div class="product-ratting">
                                    <ul>
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="ltn__small-product-item">
                            <div class="small-product-item-img">
                                <a href="product-details.php"><img src="img/product/8.png" alt="Image"></a>
                            </div>
                            <div class="small-product-item-info">
                                <div class="product-ratting">
                                    <ul>
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="ltn__small-product-item">
                            <div class="small-product-item-img">
                                <a href="product-details.php"><img src="img/product/9.png" alt="Image"></a>
                            </div>
                            <div class="small-product-item-info">
                                <div class="product-ratting">
                                    <ul>
